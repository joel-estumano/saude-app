import { ActionPipe, EntidadeFormComponent } from './components/entidade-form/entidade-form.component';
...
@NgModule({
	declarations: [ListComponent, AddComponent, EditComponent, ReadComponent, EntidadeFormComponent, ActionPipe],
	imports: [
		CommonModule,
		RegionaisModule,
